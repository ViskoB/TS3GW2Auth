...
<form action="" method="post">
    <table>
        ...
        <tr>
            ...
            <td>
                [Optional] Comma seperated list of channels ID to display. If set TSStatus will only render these
                channels
            </td>
        </tr>
        <tr>
            ...
            <td><label><input type="checkbox"
                              name="hideEmptyChannels" <?php echo(!$hideEmptyChannels ? "checked" : "") ?> /> Hide empty
                    channels</label></td>
            <td></td>
        </tr>
        <tr>
            <th></th>
            <td><label><input type="checkbox"
                              name="hideParentChannels" <?php echo(!$hideParentChannels ? "checked" : "") ?> /> Hide
                    parents channels</label></td>
            <td>To use with "Limit to these channels" and "Hide empty channels" options</td>
        </tr>
        <tr>
            <th></th>
            <td><label><input type="checkbox"
                              name="showNicknameBox" <?php echo(!$showNicknameBox ? "checked" : "") ?> /> Hide nickname
                    box</label></td>
            <td></td>
        </tr>
        <tr>
            <th></th>
            <td><label><input type="checkbox"
                              name="showPasswordBox" <?php echo(!$showPasswordBox ? "checked" : "") ?> /> Show password
                    box</label></td>
